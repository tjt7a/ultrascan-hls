...
HLS_SOURCES = ../../../../example_test.cpp ../../../../ultrascan.cpp ../../../../example.cpp
...
$(ObjDir)/ultrascan.o: ../../../../ultrascan.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../ultrascan.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/ultrascan.d
